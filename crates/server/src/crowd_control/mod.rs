...
//!    the target has a [`bevymmo_shared::crowd_control::CrowdControlState`]
//!    component, and refreshes the relevant effect timer.
...
//! 4. Movement and cast systems read
//!    [`bevymmo_shared::crowd_control::CrowdControlState::has_blocking_cc`]
//!    to suppress actions.
//! 5. The CC bar UI reads the replicated component to render a draining bar.
//!
//! `bevymmo_shared::crowd_control::CrowdControlState` is replicated +
//! predicted so the local player stops

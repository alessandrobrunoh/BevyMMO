...
use bevymmo_shared::entity::boss::components::{
    Boss, BossArena, BossPhase, BossRotationState, ThreatTable,
};
use bevymmo_shared::entity::player::components::Player;
use bevymmo_shared::network::protocol::{LookDirection, Position};
use bevymmo_shared::spells::{CastProgress, SpellCastRequest, SpellCooldowns, SpellId};
use bevymmo_shared::stats::components::{MovementStats, VitalStats};
use bevymmo_shared::stats::events::DamageEvent;

use crate::gameplay::entity::boss::target_select::{
    densest_cluster, farthest_target, main_target, PlayerRef,
};
...
fn priority_list_for(phase: BossPhase) -> Vec<RotationEntry> {
    match phase {
        BossPhase::Ground => vec![
            ...
            RotationEntry {
                spell_id: SpellId::new("dragon_claw"),
                targeting: Targeting::MainThreat,
            },
        ],

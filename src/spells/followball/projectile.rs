//! Spawn del projectile replicato per la spell Followball.
//!
//! A differenza di Fireball/HealingCircle (il cui visual è un effetto effimero
//! client-side gestito tramite `SpellVisualEffect`), la Followball crea una
...
/// Colore del proiettile Followball (azzurro).
pub const PROJECTILE_COLOR: Color = Color::srgb(0.2, 0.8, 1.0);

/// Spawna l'entità projectile replicata per Followball.

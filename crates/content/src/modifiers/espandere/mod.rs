...
use crate::abilities::{AbilityParams, ModifierEffect, ModifierRegistry};
...
/// Adds this content package to the modifier registry.
pub fn register(registry: &mut ModifierRegistry) {
    EspandereModifier::register(registry);
}
